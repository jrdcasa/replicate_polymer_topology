...
filename = "../00-INPUT_GABEDIT/PE-PESCB_gabedit.pdb" 
pattern = "Toxwaerd_twokinds"
headinfo_file = "../00-INPUT_GABEDIT/Toxwaerd_twokinds_headtail.dat"
residueinfo_file = "../00-INPUT_GABEDIT/Toxwaerd_twokinds_residues.dat"
